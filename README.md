...
├── assets/
│   ├── fonts/              # Vlastní FCC Typo fonty
│   └── icons/              # Favicon a ikony aplikace
...
| **Studie 5** | Detekce záplav | Klasifikace zaplavených oblastí v Česticích |
...
- **Performance Optimization**
  ...
  - Image caching with 50-image memory limit
...
│ │ ├── area.webp # Area overview images
│ │ ├── section.webp # Section overview images
│ │ └── extent.webp # Extent overview images
│ └── study[2-7]/ # Additional case studies
├── assets/
│ ├── fonts/ # Custom FCC Typo fonts
...
| **Study 5** | Flood Detection | Flooded area classification in Čestice |
